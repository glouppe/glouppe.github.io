...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/sail/";
          },
        },{id: "nav-publications",
          title: "publications",
          description: "",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/msc-thesis/";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-have-been-awarded-an-arc-actions-de-recherche-concertées-grant-on-ai-for-regional-climate-models-with-xavier-fettweis-a-phd-postdoc-position-is-now-available-on-this-topic-apply-now",
          title: 'I have been awarded an ARC (Actions de Recherche Concertées) grant on AI...',
          description: "",
